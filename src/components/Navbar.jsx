...
const Navbar = () => {
    return (
        <section className='bg-white shadow sticky top-0 left-0'>
            <nav className='container mx-auto flex justify-between items-center py-4 px-3 text-slate-900'>
                <Link to={""} className='font-semibold text-teal-500 text-xl'>Foton<span className='text-black'>Optix</span></Link>
                <ul className='flex justify-between gap-5 font-medium max-sm:text-sm text-base'>
